...
if ($row != 0) {
	...
	if ($response->statusCode() == 202) {
        ...
        header('location:../extend/alerta.php?msj=Tu cuenta de correo no es válida&c=us&p=in&t=error');
	}
