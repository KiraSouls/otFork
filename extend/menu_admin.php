...
<ul id="slide-out" class="side-nav fixed">
  ...
  <li><a class="<?php active('index0.php'); ?> id=" ordenes" style="font-weight: 400;letter-spacing: 1px; color: white; font-size: 16px;" href="../ots/index0.php"><i style="color: white;" class="material-icons">assignment</i>Ordenes</a></li>
