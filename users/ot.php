                ...
                <div class="card-content">
                    <form action="up_tech.php" method="post">
                        ...
                        while ($f = $sel2->fetch_assoc()) {
                            ...
                            <input disabled type="text" name="contact_name" value="<?php echo $f['contact_name'] ?> / Fono: <?php echo $f['phone'] ?>" required>
                       ...
                       WHERE number_ot = '$number_ot'"); ?>
                        ...
                        while ($f = $sel2->fetch_assoc()) {
                        ?>
                            <textarea style="height:150px;" name="com" id="" cols="60" rows="90" disabled><?php echo $comment ?></textarea>
...
<div class="row">
    <div class=" col s12">
        ...
        <div class="card horizontal" style="padding: 10px;">
            ...
            ?>
                <a href="resume_ot.php?id=<?php echo $id ?>"> <button type="=submit" class="btn light-blue darken-2" name="button" id="btn-guardar">Atender</button></a>
                        ...
                        <table class="excel responsive-table" border="1">
                            ...
                            while ($f = $sel2->fetch_assoc()) {  ?>
                                <tr>
                                    ...
                                    <td><a href="update_comment.php?id=<?php echo $id ?>" class="btn-floating light-blue darken-2"><i class="material-icons">settings_applications</i></a></td>
                                </tr>
