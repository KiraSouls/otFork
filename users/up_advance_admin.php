...
if ($_SERVER['REQUEST_METHOD']== 'POST') {
  ...
  if ($up) {
      header('location:../extend/alerta.php?msj=Avance actualizado&c=ots&p=mail&t=success&id='.$id.'');
  }else {
      header('location:../extend/alerta.php?msj=El avance no se pudo actualizar&c=ots&p=mail&t=error&id='.$id.'');
  }
