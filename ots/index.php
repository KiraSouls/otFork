        ...
        <div class="card" style="min-height: 700px;">
            <div class="card-content">
                <form action="excel.php" method="post" target="_blank" id="exportar">
                    ...
                    <button class="btn-floating light-blue darken-2 botonExcel"><i
                            class="material-icons">grid_on</i></button>
                ...
                <table class="display" id="ot_tabledata" name="ot_tabledata">
                    ...
                    <tr>
                        ...
                        <?php if ($f['status'] == "iniciada") { ?>
                        <td><a href="detail_ot.php?id=<?php echo $f['id'] ?>" class="btn-floating green"><i
                                    class="material-icons">remove_red_eye</i></a></td>
                        <?php
              }
              if ($f['status'] == "pendiente") { ?>
                        <td><a href="detail_ot.php?id=<?php echo $f['id'] ?>" class="btn-floating yellow"><i
                                    class="material-icons">remove_red_eye</i></a></td>
                        <?php  }
              if ($f['status'] === "finalizada") { ?>
                        <td><a href="detail_ot.php?id=<?php echo $f['id'] ?>" class="btn-floating grey"><i
                                    class="material-icons">remove_red_eye</i></a></td><?php } ?>
                        <td><a href="update_ot.php?id=<?php echo $f['id'] ?>"
                        ...
                        <td class="borrar"><a href="#" class="btn-floating red"
                                onclick="swal({ title:'Esta seguro que desea eliminar esta orden?',text: 'Se perderan los datos!', type: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor: '#d33', confirmButtonText: 'Si, eliminar'}).then(function (isConfirm) {
                         if(isConfirm.value){  location.href='delete_ot.php?id=<?php echo     $f['id'] ?>'; } else { location.href='index.php';} })"><i
