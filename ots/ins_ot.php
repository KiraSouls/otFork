...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $ins = $con->query("INSERT INTO ots (id_client, id_branch, id_contact, hours, created_at, type, description, id_service, leader, priority, status, tipo_visitas, number, comment, cotizacion
     ...
     VALUES ('$client', '$branch', '$contact', '$hours', '$created_at', '$type', '$description', '$service', '$leader', '$priority', '$status','$tipo_visita','$number', '', '$cotizar',
      '$detalle', '$accesorios', '$rayones', '$rupturas', '$tornillos', '$gomas', '$estado', '$observaciones', '$cargador', '$cable', '$adaptador', '$bateria', '$pantalla', '$teclado', '$drum', '$toner')");
...
<body>
    <div class="container">
        ...
        <h3>Una nueva orden en nuestros registros requiere Cotización. A continuación, encontrarán los detalles de la orden:</h3>
        <h3>  Fecha  </h3>
        <h3> ' . $created_at  . '</h3>
