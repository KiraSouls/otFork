...
$(document).ready(function () {
   $("#client").change( function () {
      ...
      $("#client option:selected").each(function () {
         id_client = $(this).val();
         $.post("data.php", {id_client: id_client
         }, function(data) {
               $("#branch").html(data);
         });
      });
...
$(document).ready(function () {
   $("#brand_name").change( function () {
      ...
      $("#brand_name option:selected").each(function () {
         id_brand = $(this).val();
         $.post("data_model.php", {id_brand: id_brand
         }, function(data) {
...
$(document).ready(function () {
   $("#branch").change( function () {
      ...
      //   });
         $.post("data_contact.php", {id_branch: id_branch
         }, function(data) {
               $("#contact").html(data);
         });
...
$(document).ready(function () {
   $("#service").change( function () {
      ...
      $("#service option:selected").each(function () {
         ...
         $.post("data_tech.php", {id_service: id_service
         }, function(data) {
               $("#leader").html(data);
